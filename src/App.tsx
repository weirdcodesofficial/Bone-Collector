...
export default function App() {
  ...
  return (
    <div
      ...
      className="min-h-screen w-full bg-[#173819] flex items-center justify-center p-0 sm:p-3 md:p-6 overflow-hidden select-none"
    >
      {/* 16:9 Landscape Desktop Canvas Shell (1920x1080) */}
      <main
        id="game-viewport-frame"
        className="relative w-full max-w-[1920px] aspect-[16/9] max-h-[100dvh] sm:max-h-[94vh] bg-[#A8D18D] rounded-none sm:rounded-[36px] overflow-hidden shadow-[0_25px_60px_-15px_rgba(0,0,0,0.7)] sm:ring-8 sm:ring-green-950/60 sm:border-4 sm:border-[#8BC34A]/50 flex flex-col mx-auto"
      >
        {gameState === 'START' && (
          <StartScreen
            highScore={highScore}
